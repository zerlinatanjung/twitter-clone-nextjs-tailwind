  ...
  return (
    <div className='flex flex-col space-x-3 border-y p-5 border-gray-100'>
        <div className='flex spcae-x-3'>
            <img className='h-10 w-10 rounded-full object-cover mr-2' src={tweet.profileImg} alt=''/>
            ...
            <div>
                ...
                {tweet.image && (
                    <img src={tweet.image} alt="" className='m-5 ml-0 mb-1max-h-60 rounded-lg object-cover shadow-sm' />
                )}
            </div>
        </div>
