...
function Tweetbox({ setTweets }: Props) {
    ...
    const postTweet = async () => {
        const tweetInfo: TweetBody = {
            ...
            profileImg: session?.user?.image || 'https://pbs.twimg.com/profile_images/1526385462973108224/N1BUvdXY_400x400.jpg',
            image: image,
        }
        ...
        <div className='flex flex-1 items-center pl-2'>
            <form className='flex flex-1 flex-col'>
                ...
                <div className='flex items-center'>
                    ...
                    disabled={!input || !session } className='bg-twitter px-5 py-2 font-bold text-white rounded-full disabled:opacity-40'>
                        Tweet
                    </button>
                </div>
